...
import static com.example.hell.inventoryapp.R.string.dollar;
...
public class CursorAdapt extends CursorAdapter {
    ...
    public CursorAdapt(MainActivity context, Cursor c) {
        super(context, c, 0);
    ...
    public void bindView(View view, final Context context, final Cursor cursor) {
        ...
        TextView priceeTextView = (TextView) view.findViewById(R.id.pricee);
